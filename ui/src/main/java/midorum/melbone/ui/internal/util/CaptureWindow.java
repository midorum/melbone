...
class CaptureWindow {
    ...
    private JFrame constructFrame() {
        ...
        frame.addKeyListener(new KeyEventListener(closeFrame, captureRegion, menu, colorHolder, opacityHolder));
        return frame;
    }
    ...
    private JPopupMenu createMenu(final Action closeFrame, final Action captureRegion, final ColorHolder colorHolder, final OpacityHolder opacityHolder) {
        ...
        popupMenu.add(createMenuItem("Capture", e -> captureRegion.perform()));
        popupMenu.addSeparator();
        popupMenu.add(createSubMenu("Color",
        ...
        popupMenu.add(createSubMenu("Opaque",
        ...
        popupMenu.addSeparator();
        popupMenu.add(createMenuItem("Close", e -> closeFrame.perform()));
        return popupMenu;
    }
    ...
    public static class KeyEventListener implements KeyListener {

        private final Action closeFrame;
        private final Action makeScreenShot;
        private final JPopupMenu popupMenu;
        private final ColorHolder colorHolder;
        private final OpacityHolder opacityHolder;

        public KeyEventListener(final Action closeFrame, final Action makeScreenShot, final JPopupMenu popupMenu, final ColorHolder colorHolder, OpacityHolder opacityHolder) {
        ...
        private void moveComponent(Component component, int x, int y) {
            ...
            component.setLocation(new Point(
                    (int) (currentLocation.getX() + x),
                    (int) currentLocation.getY() + y));
        }
