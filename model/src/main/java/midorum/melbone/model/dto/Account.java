...
public class Account implements Serializable {
    ...
    private Account(final String name, final String login, final String password, final int order) {
        this.name = name;
        this.login = login;
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(name, account.name) && Objects.equals(login, account.login) && Objects.equals(password, account.password);
    }
