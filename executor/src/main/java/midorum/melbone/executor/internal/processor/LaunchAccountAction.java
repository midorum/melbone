...
public class LaunchAccountAction implements VoidActionThrowing<InterruptedException> {
    ...
    private boolean isTargetProcessesLimitReached() {
        return settings.application().maxAccountsSimultaneously() <= windowFactory.countAllTargetProcesses();
    }

    private void closeAllUnnecessaryWindowsAndCheckHealthForRest() {
    ...
    private void launchAccount(final Account account, final Delay delay) throws InterruptedException {
    ...
    private void findOrStartLauncherAndLoginAccount(final Account account) throws InterruptedException {
    ...
    private Optional<BaseAppWindow> waitForBaseAppWindowAndBindItWithAccount(final Account account, final Delay delay) throws InterruptedException {
    ...
    private void checkLauncherIsReadyAndStartGame() throws InterruptedException {
